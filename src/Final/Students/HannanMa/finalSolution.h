...
// Seam point - add another interface.
	...
	public:
		string sPlasticName;
		virtual void clean(){}
		virtual ~CleanPlastic_A_2(){fos<<"CleanPlastic_A_2 "<<endl;}
	...
	public:
		...
		~Synthetics_Clean(){fos<<"~adapter::Synthetics_Clean "<<endl;}
		void clean()
		{
	...
	public:
		...
		~PET_Clean(){fos<<"~adapter::PET_Clean "<<endl;}
		void clean(){
	...
	public:
		...
		~Poly_Clean(){fos<<"~adapter::Poly_Clean "<<endl;}
		void clean()
		{
	...
	public:
		...
		~ABS_Clean(){fos<<"~adapter::ABS_Clean "<<endl;}
		void clean()
		{
			oCleanABS.clean();
		}
...
namespace observer {		// DP 5.
	...
	public:
		string sStufferName;
		virtual ~Stuffer(){fos<<"~Stuffer "<<endl;}
	...
	public:
		...
		virtual ~Popcorn(){fos<<"~Popcorn "<<endl;}
		void update(observer::Subject_7 *pSubject)
		{
			Stuffer::update(pSubject);
		}
	...
	public:
		...
		virtual ~BubbleWrap(){fos<<"~BubbleWrap "<<endl;}
		void update(observer::Subject_7 *pSubject)
		{
			Stuffer::update(pSubject);
		}
	...
	Stuffer * Stuffer::create_stuffer(string &sStufferName)
	{
		...
		{
			fos<<"  <>Unknown stuffer || defaulting to 'None'."<<endl;
			return new observer::Air;
		}
	}
	...
	public:
		...
		void notify()
		{
			fos<<"      Whenever "<<sPackageBinName.c_str()<<" package bin was full..."<<endl;
...
namespace abstract_factory {// DP 9.
	...
	public:
		int CavityNum;
		virtual ~IJM_AF(){fos<<"~IJM_AF "<<endl;}
		void update(observer::Subject_7 *pSubject)
		{
	...
	public:
		...
		~Aluminum(){fos<<"~Aluminum "<<endl;}
	};
	class Steel : public Mold_AF
	{
	public:
		Steel(){sMetal = "steel";}
		~Steel(){fos<<"~Steel "<<endl;}
	};

	class ConveyerBelt_AF : public observer::Observer_7
	{
	public:
		virtual ~ConveyerBelt_AF(){fos<<"~ConveyerBelt_AF "<<endl;}
		void update(observer::Subject_7 *pSubject)
		{
	...
	public:
		...
		~CardboardBox(){fos<<"~CardboardBox "<<endl;}
	};
	...
	public:
		...
		~PilotOrder(){fos<<"~PilotOrder"<<endl;}
	...
	public:
		...
		~SmallOrder(){fos<<"~SmallOrder"<<endl;}
	...
	public:
		...
		~MediumOrder(){fos<<"~MediumOrder"<<endl;}
	...
	public:
		...
		~LargeOrder(){fos<<"~LargeOrder"<<endl;}
	...
	Setup_AF_10 * Setup_AF_10::createOrder(int &orderSize)
	{
		...
		{
			fos<<"  <>size exceeds mold lifetime |"<<orderSize<<"| defaulting to HugeOrder of 200000."<<endl;
			orderSize = 200000;
			return new HugeOrder(orderSize);
		}
	}
...
// Seam Point - add another implementation.
	...
	public:
		...
		virtual ~HighCarbon(){fos<<"~HighCarbon "<<endl;}
	...
	public:
		...
		virtual ~Carbide(){fos<<"~Carbide "<<endl;}
		void Mill_Shape(const string &in_finish, const string &sMold)
		{
	...
	public:
		...
		virtual ~DiamonTipped(){fos<<"~DiamonTipped "<<endl;}
		void Mill_Shape(const string &in_finish, const string &sMold)
		{
...
// Seam points - add another responder.
	...
	public:
		...
		virtual ~GetMold_CofR_8(){fos<<"~GetMold_CofR_8 "<<endl;}
	...
	{
	public:
		~SisterCompany(){fos<<"~SisterCompany "<<endl;}
		void GetMold(string &sMoldLoc, string &sMold, int CavictyNum)
		{
...
namespace decorator {		// DP 6.
	...
	public:
		...
		virtual ~AdditiveDecorator(){fos<<"~AdditiveDecorator "<<endl;}
	};
	...
	public:
		...
		virtual ~AntiBacterial(){fos<<"~AntiBacterial "<<endl;}
		void PrintRecipe()
		{
	...
	public:
		...
		virtual ~UVInhibiter(){fos<<"~UVInhibiter "<<endl;}
		void PrintRecipe()
		{
			pPlasticAdditive->PrintRecipe();
	...
	public:
		...
		virtual ~MicroFiber(){fos<<"~MicroFiber "<<endl;}
		void PrintRecipe()
		{
			pPlasticAdditive->PrintRecipe();
	...
	public:
		...
		virtual ~Polypropylene(){fos<<"~Polypropylene "<<endl;}
	...
	public:
		...
		virtual ~Polyethelene(){fos<<"~Polyethelene "<<endl;}
		void PrintRecipe()
		{
			pPlasticAdditive->PrintRecipe();
	...
	public:
		...
		virtual ~Styrene(){fos<<"~Styrene "<<endl;}
		void PrintRecipe()
		{
			pPlasticAdditive->PrintRecipe();
			fos<<"Styrene("<<volume<<") ";
	...
	public:
		...
		virtual ~Nilon66(){fos<<"~Nilon66 "<<endl;}
		void PrintRecipe()
		{
			pPlasticAdditive->PrintRecipe();
			fos<<"Nylon66("<<volume<<") ";
	...
	public:
		...
		~ModelNumber(){fos<<"~ModelNumber "<<endl;}
		void insertTags()
		{
			fos<<"ModelNumber ";
		}
	...
	public:
		...
		~IncrementCounter(){fos<<"~IncrementCounter "<<endl;}
		void insertTags()
		{
			fos<<"IncCounter ";
		}
	...
	public:
		...
		~PartNumber(){fos<<"~PartNumber "<<endl;}
		void insertTags()
		{
			fos<<"PartNumber ";
		}
	...
	public:
		...
		~RecycleCode(){fos<<"~RecycleCode "<<endl;}
		void insertTags()
		{
			fos<<"RecycleCode ";
		}
...
namespace factory_method {	// DP 4.
	...
	{
	public:
		~ShrinkWrap(){fos<<"~ShrinkWrap "<<endl;}
	};

	class HardPack : public Packager_FM_5
	{
	public:
		~HardPack(){fos<<"~HardPack "<<endl;}
	};
	class ZipLock : public Packager_FM_5
	{
	public:
		~ZipLock(){fos<<"~ZipLock "<<endl;}
	};
	...
	Packager_FM_5 * Packager_FM_5::createPackager(string &sPackager)
	{
		...
		{
			sPackager = "Bulk";
			fos<<"  <>Unknown packager || defaulting to 'None'."<<endl;
			return new Bulk;
		}
	}
}
