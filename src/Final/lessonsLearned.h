...
#ifndef FINAL_LESSONSLEARNED_H_
#define FINAL_LESSONSLEARNED_H_
 ...
 *  	9.1  Time: 2 hrs => A(4), 3 hrs => B(3), 4 hrs => C(2), 5 hrs => D(5).
 ...
 x 12.	Dtor instrumentation should be a command line option
 x 13.	Tag blank should depend on mold shape (18 to 26 mm, say)
 x 14.	Molds should have a duration count and limit
 x 15.	Mold duration should depend on 'glassiness' of plastic
 * 16.	Recipe should account for additives more realistically
 x 17.	Add inventory/Sister objects to hold existing & new molds (life & limit)
 x 18.	CofR should depend on inventory object & required run size
 x 19.	Molds with life < 10% should be chucked, rest returned to inventory
 x 20.	Add more metals (alloys)
 ...
 * 31.	Correct tag list spacing inside brackets [Country Date]
 x 32.	Make design pattern dtor number a coding option
 x 33.	Allow multiple molds of the same shape (pick one w/ enough life)
 ...
 * 35.	One of the initially constant TM_4 steps should have to become virtual
 x 36.	Consider adding dryers, visual inspection, rejections affect run size
