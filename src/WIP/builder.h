 ...
 *
 * Desc: Missed squash merge. Trying to correct. Still trying.
 *
 * Possible Examples:
 * 	1) Vehicles (
 * 	2) RTL ( sim, fpga, Si, GaAs, graphene )
 * 	3) Doc ( Web page, Word Doc, pdf, phone screen, terminal )
 * 	4) UML DP ( C++, Java, Python, Ruby, C# )
 * 	5) HelloWorld ( C, C++, Java, Python, Ruby )
 * 		return type
 * 		function name
 * 		args
 * 		opening brace
 ...
 * 		return
 * 		closing brace
 * 		There is a web page that lists all the hello world programs, easy peasy.
 *
 * Category: Creational
 *
 *  URLs:
